            ...
            <section className="mx-auto w-full max-w-7xl">
                <div className="mb-8 flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
                    ...
                    <button
                        ...
                        disabled={carregando}
                        className="group inline-flex h-11 w-fit items-center justify-center rounded-md border border-[#22D3EE]/30 bg-[#F0F2F4]/[0.035] px-6 text-center text-sm transition-all duration-300 ease-out shadow-[0_0_15px_rgba(34,211,238,0.05)] hover:-translate-y-0.5 hover:scale-[1.03] hover:border-[#22D3EE]/60 hover:bg-[#F0F2F4]/[0.065] hover:shadow-[0_0_25px_rgba(34,211,238,0.2)] disabled:opacity-40 disabled:cursor-not-allowed disabled:hover:translate-y-0 disabled:hover:scale-100"
                    >
                    ...
                    >
                        ...
                        <div className="mt-6 flex justify-end gap-3">
                            <button
                                type="button"
                                onClick={fecharFormulario}
                                className="h-11 rounded-md border border-white/10 px-5 text-sm uppercase font-bold text-[#A1A1AA] transition hover:border-white/30 hover:text-white"
                            >
                                Cancelar
                            </button>
                            ...
                            >
                                {carregando ? (
                                    ...
                                    <span className="animated-gradient-text uppercase tracking-[0.08rem] font-bold">
                                        {colaboradorEditandoId ? 'Salvar' : 'Cadastrar'}
                                    </span>
                                )}
                            </button>
