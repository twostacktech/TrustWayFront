...
export default function Register() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#0a0a0a] via-[#0f0a1a] to-[#0a0a0a] flex items-center justify-center p-6 text-[#F0F2F4] antialiased font-['Inter']">
      <div className="max-w-6xl w-full grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="space-y-6 flex flex-col items-center text-center lg:items-start lg:text-left">
          <div className="flex flex-col items-center text-center lg:items-start lg:text-left pt-10 md:pt-16 lg:pt-0 space-y-4 w-full">
            <h1 className="hidden md:block font-['Anton'] text-4xl sm:text-5xl md:text-6xl lg:text-[4.5rem] uppercase tracking-wide text-[#FAFAFA] leading-[0.85]">
              Crie agora
            </h1>
            <h1 className="hidden md:block -mt-1 md:-mt-1 lg:mt-0 font-['Anton'] text-4xl sm:text-5xl md:text-6xl lg:text-[4.5rem] uppercase tracking-wide text-[#FAFAFA] leading-[0.85]">
              sua conta
            </h1>
      ...
      aria-label="Crie agora sua conta Trustway"
      role="img"
    >
      <text 
        x="50%" 
      ...
      >
        {/* Linha 1 */}
        <tspan x="50%" dy="125">CRIE AGORA</tspan>
