  ...
  const handleRegister = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await cadastrarUsuario(
        "/usuario",
        { cpf, nome, tipo, dataNascimento, email, senha, numeroTelefone },
        () => {},
      );
      navigate("/login");
    } catch (err: unknown) {
      ...
      <div className="max-w-6xl w-full grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="space-y-6 flex flex-col items-center text-center lg:items-start lg:text-left">
          <div className="flex flex-col items-center text-center lg:items-start lg:text-left space-y-1 w-full">
            <h1 className="font-['Anton'] text-3xl sm:text-5xl md:text-6xl lg:text-[5.5rem] uppercase tracking-wide text-[#FAFAFA] leading-tight lg:leading-[0.85]">
              Crie agora
            </h1>
            <h1 className="font-['Anton'] text-3xl sm:text-5xl md:text-6xl lg:text-[5.5rem] uppercase tracking-wide text-[#FAFAFA] leading-tight lg:leading-[0.85]">
              sua conta
            ...
            <p className="text-[#FFFFFFFF]/80 text-sm sm:text-base lg:text-lg max-w-md pt-4 lg:pr-8">
              Tenha acesso à plataforma de seguro automotivo mais robusta do
              mercado.
            </p>
          </div>
        </div>
        ...
        <div className="w-full max-w-xl border border-[#22D3EE]/15 bg-[#F0F2F4]/[0.025] backdrop-blur-md p-6 sm:p-8 rounded-2xl shadow-[0_0_50px_rgba(34,211,238,0.05)] relative overflow-hidden mx-auto lg:mx-0">
          ...
          <form className="space-y-4 sm:space-y-5" onSubmit={handleRegister}>
            <div className="flex flex-col space-y-2">
              <label className="text-[0.8rem] sm:text-[0.85rem] font-black tracking-[0.12rem] text-[#22D3EE] uppercase">
                Nome Completo
              </label>
              <input
                type="text"
